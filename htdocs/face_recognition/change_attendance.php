...
<?php //same shit as in view_timetable.php
	...
	function makeButton ($condition) {
		echo "<div class='dropdown'>";
  		echo "<button id='btn5' onclick='dropMenuFunction(this.id)' class='dropbtn'>".$condition."</button>";
  		echo "<div id='myDropdown5' class='dropdown-content'>";

					include_once('php/connect_database.php');

					echo "<a href='#' id='atnButton' onclick='getButtonId(this.text)' >";
					echo ""
					echo "</a>";
